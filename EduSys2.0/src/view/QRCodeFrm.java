...
public class QRCodeFrm extends javax.swing.JInternalFrame implements Runnable, ThreadFactory {
    ...
    private BaseDaoInterface dao, daoQR;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(2, 5, 770, 570));
    ...
    private void initWebcam() {
        ...
        jPanel1.add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 710, 440));
        ...
        do {
            ...
            if (result != null) {
                try {
                    ...
                    MyQRCode qr = (MyQRCode) daoQR.selectByID(result.getText());
                    if (qr != null) {
                        Auth.nguoiDungHienTai = (NhanVien) dao.selectByID(qr.getMaNV());
                        qrCode = 1;
                        HomeFrm.home = 0;
                        LogInFrm.frmLogIn = 0;
