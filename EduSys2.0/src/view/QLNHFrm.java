...
public class QLNHFrm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtTimKiem.setPreferredSize(new java.awt.Dimension(3, 15));
        ...
        cbxTimKiem.setPreferredSize(new java.awt.Dimension(205, 20));
    ...
    private boolean checkForm() {
        ...
        } else if (MyValidate.isNotStudenCode(txtMaNH)) {
            loi.append("Mã người học không đúng định dạng\n"
                    + "VD: PH18623");
        }
        ...
        } else if (MyValidate.isNotNumberPhone(txtSDT)) {
