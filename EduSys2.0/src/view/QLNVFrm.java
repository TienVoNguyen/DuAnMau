...
public class QLNVFrm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/login32.png"))); // NOI18N
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        if (Auth.nguoiDungHienTai.getMaNV().equals(txtIDNV.getText())) {
            MyMess.msgWarning(this, "Bạn không thể sửa thông tin của mình!");
            return;
        }
        if (suaNhanVien());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
        if (Auth.nguoiDungHienTai.getMaNV().equals(txtIDNV.getText())) {
            MyMess.msgWarning(this, "Bạn không thể xoá thông tin của mình!");
            return;
        }
        if (xoaNhanVien());
    ...
    private void setDataRow(NhanVien nv) {
        ...
        vt = nv.isVaiTro() ? "Trưởng phòng" : "Nhân viên";
    ...
    private void showForm(int i) {
        ...
        if (tblQLNV.getValueAt(i, 3).equals("Trưởng phòng")) {
            isVT = true;
        }
    ...
    private boolean checkForm() {
        ...
        } else if (MyValidate.isNotEmail(txtEmail)) {
